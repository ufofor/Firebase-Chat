...
//  FirebaseChat
//
//  Created by Sean Kang on 2020/10/23.
//
...
class RegisterViewController: UIViewController {
    ...
    func alertUserLoginError() {
        let alert = UIAlertController(title: "Woops", message: "Plase Enter All Information to create a new account", preferredStyle: .alert)
